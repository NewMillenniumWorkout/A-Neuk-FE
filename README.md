...
## 📊 기대 효과  
- **심리적 장벽 제거**: 사용자가 일기 작성을 편하게 느끼도록 지원  
- **감정적 인지 능력 강화**: 다양한 감정을 인식하고 학습  
- **정신적/신체적 회복 지원**: 감정 표현의 확장을 통해 정서적 건강 개선  
...
| 이름      | 역할         |              |  
|-----------|--------------|----------------------|  
| 김민식   | FE, Design  | UI/UX 설계 및 디자인, 프론트엔드 개발 |  
| 장민석   | AI, Infra    | AI 서버 및 인프라 관리 |  
| 김여진   | BE, DB       | 백엔드 및 데이터베이스 설계 |  
